...
void ReceivedCallback(uint32_t *msgPtr)
{
    ...
    {
        case 0u:    /* OFF OFF OFF */
            Cy_GPIO_Write(CY_CB_LED_PORT, CY_CB_LED_PIN, 1u);
            Cy_GPIO_Write(CY_CB_LED2_PORT, CY_CB_LED2_PIN, 1u);
            Cy_GPIO_Write(CY_CB_LED3_PORT, CY_CB_LED3_PIN, 1u);
            break;
        case 1u:    /* ON OFF OFF */
            Cy_GPIO_Write(CY_CB_LED_PORT, CY_CB_LED_PIN, 0u);
            Cy_GPIO_Write(CY_CB_LED2_PORT, CY_CB_LED2_PIN, 1u);
            Cy_GPIO_Write(CY_CB_LED3_PORT, CY_CB_LED3_PIN, 1u);
            break;
        case 2u:    /* OFF ON OFF */
            Cy_GPIO_Write(CY_CB_LED_PORT, CY_CB_LED_PIN, 1u);
            Cy_GPIO_Write(CY_CB_LED2_PORT, CY_CB_LED2_PIN, 0u);
            Cy_GPIO_Write(CY_CB_LED3_PORT, CY_CB_LED3_PIN, 1u);
            break;
        case 3u:    /* OFF OFF ON */
            Cy_GPIO_Write(CY_CB_LED_PORT, CY_CB_LED_PIN, 1u);
            Cy_GPIO_Write(CY_CB_LED2_PORT, CY_CB_LED2_PIN, 1u);
            Cy_GPIO_Write(CY_CB_LED3_PORT, CY_CB_LED3_PIN, 0u);
            break;
        case 4u:    /* ON ON ON */ 
            Cy_GPIO_Write(CY_CB_LED_PORT, CY_CB_LED_PIN, 0u);
            Cy_GPIO_Write(CY_CB_LED2_PORT, CY_CB_LED2_PIN, 0u);
...
int main(void)
{
    ...
    Cy_GPIO_Pin_Init(CY_CB_LED3_PORT, CY_CB_LED3_PIN, &user_led2_port_pin_cfg);
