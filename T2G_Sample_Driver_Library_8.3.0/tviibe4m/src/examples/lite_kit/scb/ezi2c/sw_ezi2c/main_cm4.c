...
#define USER_I2C_SCB_TYPE           CY_SCB_I2C_TYPE
#define USER_I2C_SCB_PCLK           CY_SCB_I2C_PCLK
#define USER_I2C_SCB_IRQN           CY_SCB_I2C_IRQN

#define I2C_SDA_PORT                CY_SCB_I2C_SDA_PORT
#define I2C_SDA_PORT_PIN            CY_SCB_I2C_SDA_PIN
#define I2C_SDA_PORT_MUX            CY_SCB_I2C_SDA_PIN_MUX

#define I2C_SCL_PORT                CY_SCB_I2C_SCL_PORT
#define I2C_SCL_PORT_PIN            CY_SCB_I2C_SCL_PIN
#define I2C_SCL_PORT_MUX            CY_SCB_I2C_SCL_PIN_MUX
