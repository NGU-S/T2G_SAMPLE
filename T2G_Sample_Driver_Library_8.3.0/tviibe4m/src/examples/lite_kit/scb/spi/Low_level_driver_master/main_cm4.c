...
#define CY_SPI_SCB_TYPE      CY_SCB_TYPE
#define CY_SPI_SCB_MISO_PORT CY_SCB_MISO_PORT
#define CY_SPI_SCB_MISO_PIN  CY_SCB_MISO_PIN
#define CY_SPI_SCB_MISO_MUX  CY_SCB_MISO_PIN_MUX

#define CY_SPI_SCB_MOSI_PORT CY_SCB_MOSI_PORT
#define CY_SPI_SCB_MOSI_PIN  CY_SCB_MOSI_PIN
#define CY_SPI_SCB_MOSI_MUX  CY_SCB_MOSI_PIN_MUX

#define CY_SPI_SCB_CLK_PORT  CY_SCB_SCK_PORT
#define CY_SPI_SCB_CLK_PIN   CY_SCB_SCK_PIN
#define CY_SPI_SCB_CLK_MUX   CY_SCB_SCK_PIN_MUX

#define CY_SPI_SCB_SEL0_PORT CY_SCB_SS0_PORT
#define CY_SPI_SCB_SEL0_PIN  CY_SCB_SS0_PIN
#define CY_SPI_SCB_SEL0_MUX  CY_SCB_SS0_PIN_MUX

#define CY_SPI_SCB_PCLK      CY_SCB_PCLK
#define CY_SPI_SCB_IRQN      CY_SCB_IRQN
