...
#define USER_LED1_PORT    CY_CB_LED2_PORT
#define USER_LED1_PIN     CY_CB_LED2_PIN
#define USER_LED1_PIN_MUX CY_CB_LED2_PIN_MUX

#define USER_LED2_PORT    CY_CB_LED3_PORT
#define USER_LED2_PIN     CY_CB_LED3_PIN
#define USER_LED2_PIN_MUX CY_CB_LED3_PIN_MUX
