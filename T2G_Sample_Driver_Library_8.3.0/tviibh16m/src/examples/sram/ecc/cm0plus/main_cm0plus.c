...
void irqFaultReport0Handler(void)
{
    ...
    {
        if(fault_source == CY_SYSFLT_CPUSS_RAMC0_NC_ECC) // System SRAM 0 non-correctable ECC error
        {
        ...
        if(fault_source == CY_SYSFLT_CPUSS_RAMC0_C_ECC) // System SRAM 0 correctable ECC error
        {
            faultData0 = Cy_SysFlt_GetData0(FAULT_STRUCT0);
            faultData1 = Cy_SysFlt_GetData1(FAULT_STRUCT0);
            faultData2 = Cy_SysFlt_GetData2(FAULT_STRUCT0);
...
{    
    ...
    ***************************************************************************/
    ...
    
    {
        ...
        Cy_SysFlt_SetMaskByIdx(FAULT_STRUCT0, CY_SYSFLT_CPUSS_RAMC0_C_ECC); // enable Fault System SRAM 0 non-correctable ECC error
        Cy_SysFlt_SetMaskByIdx(FAULT_STRUCT0, CY_SYSFLT_CPUSS_RAMC0_NC_ECC); // enable Fault System SRAM 0 non-correctable ECC error
        //Cy_SysFlt_SetMaskByIdx(FAULT_STRUCT0, CY_SYSFLT_CPUSS_RAMC1_C_ECC); // enable Fault System SRAM 0 non-correctable ECC error
        //Cy_SysFlt_SetMaskByIdx(FAULT_STRUCT0, CY_SYSFLT_CPUSS_RAMC1_NC_ECC); // enable Fault System SRAM 0 non-correctable ECC error
        //Cy_SysFlt_SetMaskByIdx(FAULT_STRUCT0, CY_SYSFLT_CPUSS_RAMC2_C_ECC); // enable Fault System SRAM 0 non-correctable ECC error
        //Cy_SysFlt_SetMaskByIdx(FAULT_STRUCT0, CY_SYSFLT_CPUSS_RAMC2_NC_ECC); // enable Fault System SRAM 0 non-correctable ECC error
    ...
    ***************************************************************************/
    ...
    if((isr_triggered != 0) && (faultData0 != RAM_ADDRESS) && (fault_source != CY_SYSFLT_CPUSS_RAMC0_NC_ECC))
    {
        fail ++;
    }
    else
