...
#define USER_BUTTON_PORT        CY_CB_HIB_WAKE_BUTTON_PORT
#define USER_BUTTON_PIN         CY_CB_HIB_WAKE_BUTTON_PIN
#define USER_BUTTON_PIN_MUX     CY_CB_HIB_WAKE_BUTTON_PIN_MUX
#define USER_BUTTON_IRQ         CY_CB_HIB_WAKE_BUTTON_IRQN
