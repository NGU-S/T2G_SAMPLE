...
/* Counter Configuration def */
  ...
  #define TCPWM_TR_ONE_CNT_INx_MUX                P6_4_TCPWM0_TR_ONE_CNT_IN0

  #define GIPO_FOR_COUNT_PORT                     GPIO_PRT8
  #define GIPO_FOR_COUNT_PIN                      0u
  #define GIPO_FOR_COUNT_MUX                      P8_0_GPIO
