...
#define TCPWMx_LINEx_MUX                  P6_0_TCPWM0_LINE0

#define TR_ONE_CNT_NR_USE                 0u // from 0 to 2
// TR_ONE_CNT_INx: x = (256 * GrpNum) + (CntNum)
#define TCPWMx_LINEx_IN_PORT              GPIO_PRT6
#define TCPWMx_LINEx_IN_PIN               4u
#define TCPWMx_LINEx_IN_MUX               P6_4_TCPWM0_TR_ONE_CNT_IN0

#define GPIO_TOBE_COPYED_PORT             GPIO_PRT5
#define GPIO_TOBE_COPYED_PIN              2u
#define GPIO_TOBE_COPYED_MUX              P5_2_GPIO
