...
#define TCPWMx_GRPx_CNTx_PWM_INST1            TCPWM1_GRP0_CNT7
#define PCLK_TCPWMx_CLOCKSx_PWM_INST1         PCLK_TCPWM1_CLOCKS7
#define TCPWM_PERI_CLK_DIVIDER_NO_PWM_INST1   0u

/* TCPWM LINE Output for 1st instance */
#define TCPWMx_LINEx_PORT_INST1                GPIO_PRT4
#define TCPWMx_LINEx_PIN_INST1                 3u 
#define TCPWMx_LINEx_MUX_INST1                 P4_3_TCPWM1_LINE7
...
#define TCPWMx_GRPx_CNTx_PWM_INST2            TCPWM1_GRP0_CNT8
#define PCLK_TCPWMx_CLOCKSx_PWM_INST2         PCLK_TCPWM1_CLOCKS8
#define TCPWM_PERI_CLK_DIVIDER_NO_PWM_INST2   1u

/* TCPWM LINE Output for 2nd instance */
#define TCPWMx_LINEx_PORT_INST2                GPIO_PRT4
#define TCPWMx_LINEx_PIN_INST2                 4u
#define TCPWMx_LINEx_MUX_INST2                 P4_4_TCPWM1_LINE8
...
#define TCPWMx_GRPx_CNTx_PWM_INST3            TCPWM1_GRP0_CNT9
#define PCLK_TCPWMx_CLOCKSx_PWM_INST3         PCLK_TCPWM1_CLOCKS9
#define TCPWM_PERI_CLK_DIVIDER_NO_PWM_INST3   2u

/* TCPWM LINE Output for 3rd instance */
#define TCPWMx_LINEx_PORT_INST3                GPIO_PRT5
#define TCPWMx_LINEx_PIN_INST3                 0u
#define TCPWMx_LINEx_MUX_INST3                 P5_0_TCPWM1_LINE9

/* Please check TCPWM1_LINE0 outputs the 976.5625Hz pulse with duty 50% by Oscilloscope. */
/* PWM Mode Configuration def for 4th instance*/
#define TCPWMx_GRPx_CNTx_PWM_INST4            TCPWM1_GRP0_CNT0
#define PCLK_TCPWMx_CLOCKSx_PWM_INST4         PCLK_TCPWM1_CLOCKS0
#define TCPWM_PERI_CLK_DIVIDER_NO_PWM_INST4   3u

/* TCPWM LINE Output for 4th instance */
#define TCPWMx_LINEx_PORT_INST4                GPIO_PRT6
#define TCPWMx_LINEx_PIN_INST4                 1u
#define TCPWMx_LINEx_MUX_INST4                 P6_1_TCPWM1_LINE0

/* Please check TCPWM1_LINE1 outputs the 976.5625Hz pulse with duty 50% by Oscilloscope. */
/* PWM Mode Configuration def for 5th instance*/
#define TCPWMx_GRPx_CNTx_PWM_INST5            TCPWM1_GRP0_CNT1
#define PCLK_TCPWMx_CLOCKSx_PWM_INST5         PCLK_TCPWM1_CLOCKS1
#define TCPWM_PERI_CLK_DIVIDER_NO_PWM_INST5   4u

/* TCPWM LINE Output for 5th instance */
#define TCPWMx_LINEx_PORT_INST5               GPIO_PRT3  
#define TCPWMx_LINEx_PIN_INST5                0ul 
#define TCPWMx_LINEx_MUX_INST5                P3_0_TCPWM1_LINE1 

/* Please check TCPWM1_LINE2 outputs the 976.5625Hz pulse with duty 50% by Oscilloscope. */
/* PWM Mode Configuration def for 6th instance*/
#define TCPWMx_GRPx_CNTx_PWM_INST6            TCPWM1_GRP0_CNT2 
#define PCLK_TCPWMx_CLOCKSx_PWM_INST6         PCLK_TCPWM1_CLOCKS2
#define TCPWM_PERI_CLK_DIVIDER_NO_PWM_INST6   5u

/* TCPWM LINE Output for 6th instance */
#define TCPWMx_LINEx_PORT_INST6                GPIO_PRT2 
#define TCPWMx_LINEx_PIN_INST6                 5ul
#define TCPWMx_LINEx_MUX_INST6                 P2_5_TCPWM1_LINE2

/* Please check TCPWM1_LINE3 outputs the 976.5625Hz pulse with duty 50% by Oscilloscope. */
/* PWM Mode Configuration def for 7th instance*/
#define TCPWMx_GRPx_CNTx_PWM_INST7            TCPWM1_GRP0_CNT3 
#define PCLK_TCPWMx_CLOCKSx_PWM_INST7         PCLK_TCPWM1_CLOCKS3
#define TCPWM_PERI_CLK_DIVIDER_NO_PWM_INST7   6u

/* TCPWM LINE Output for 7th instance */
#define TCPWMx_LINEx_PORT_INST7                GPIO_PRT6 
#define TCPWMx_LINEx_PIN_INST7                 7ul
#define TCPWMx_LINEx_MUX_INST7                 P6_7_TCPWM1_LINE3

/* Please check TCPWM1_LINE4 outputs the 976.5625Hz pulse with duty 50% by Oscilloscope. */
/* PWM Mode Configuration def for 8th instance*/
#define TCPWMx_GRPx_CNTx_PWM_INST8            TCPWM1_GRP0_CNT4 
#define PCLK_TCPWMx_CLOCKSx_PWM_INST8         PCLK_TCPWM1_CLOCKS4
#define TCPWM_PERI_CLK_DIVIDER_NO_PWM_INST8   7u

/* TCPWM LINE Output for 8th instance */
#define TCPWMx_LINEx_PORT_INST8               GPIO_PRT4  
#define TCPWMx_LINEx_PIN_INST8                0ul 
#define TCPWMx_LINEx_MUX_INST8                P4_0_TCPWM1_LINE4 

/* Please check TCPWM1_LINE5 outputs the 976.5625Hz pulse with duty 50% by Oscilloscope. */
/* PWM Mode Configuration def for 9th instance*/
#define TCPWMx_GRPx_CNTx_PWM_INST9            TCPWM1_GRP0_CNT5 
#define PCLK_TCPWMx_CLOCKSx_PWM_INST9         PCLK_TCPWM1_CLOCKS5
#define TCPWM_PERI_CLK_DIVIDER_NO_PWM_INST9   8u

/* TCPWM LINE Output for 9th instance */
#define TCPWMx_LINEx_PORT_INST9                GPIO_PRT4 
#define TCPWMx_LINEx_PIN_INST9                 1ul
#define TCPWMx_LINEx_MUX_INST9                 P4_1_TCPWM1_LINE5

/* Please check TCPWM1_LINE6 outputs the 976.5625Hz pulse with duty 50% by Oscilloscope. */
/* PWM Mode Configuration def for 10tt instance*/
#define TCPWMx_GRPx_CNTx_PWM_INST10           TCPWM1_GRP0_CNT6 
#define PCLK_TCPWMx_CLOCKSx_PWM_INST10        PCLK_TCPWM1_CLOCKS6
#define TCPWM_PERI_CLK_DIVIDER_NO_PWM_INST10  9u

/* TCPWM LINE Output for 10th instance */
#define TCPWMx_LINEx_PORT_INST10               GPIO_PRT4 
#define TCPWMx_LINEx_PIN_INST10                2ul
#define TCPWMx_LINEx_MUX_INST10                P4_2_TCPWM1_LINE6
...
cy_stc_tcpwm_pwm_config_t MyPWM_config =
{
    ...
    .clockPrescaler     = TCPWMx_PWM_PRESCALAR_DIV_x, // 2,000,000 / 128 = 15,625Hz
    .debug_pause        = false,
    ...
    .period             = TCPWMx_PERIOD - 1,                        // 15,625 / 16 = 976.5625Hz (PWM frequency)
    .period_buff        = 0,
