...
#if defined(CY_216TEQFP_EVK_rev_a)
...
#elif defined(CY_272BGA_EVKLITE_rev_a)
    #define MCAL_PROJECT_CB_BUTTON_1_ICU_IRQ_NUMBER         26
    #define MCAL_PROJECT_CB_BUTTON_1_ICU_IRQ_HANDLER        Icu_Isr_Vector_26_Cat2
