...
typedef enum
{
    ...
    CY_GFXENV_DISP_TYPE_640_480_60_FPD_VESA,   /**< Display with resolution 1600x480, refresh rate 60 Hz, FPD-Link interface, signal mapping according to VESA standard */
    CY_GFXENV_DISP_TYPE_640_480_60_FPD_JEIDA,  /**< Display with resolution 1600x480, refresh rate 60 Hz, FPD-Link interface, signal mapping according to VESA standard */
    CY_GFXENV_DISP_TYPE_1280_720_60_FPD_VESA,  /**< Display with resolution 1280x768, refresh rate 60 Hz, FPD-Link interface, signal mapping according to VESA standard */
    CY_GFXENV_DISP_TYPE_1024_600_60_FPD_VESA,  /**< Display with resolution 1280x768, refresh rate 60 Hz, FPD-Link interface, signal mapping according to VESA standard */
    CY_GFXENV_DISP_TYPE_720_480_60_FPD_VESA,    /**< Display with resolution 1280x768, refresh rate 60 Hz, FPD-Link interface, signal mapping according to VESA standard */
    CY_GFXENV_DISP_TYPE_720_576_50_FPD_VESA,    /**< Display with resolution 1280x768, refresh rate 60 Hz, FPD-Link interface, signal mapping according to VESA standard */
