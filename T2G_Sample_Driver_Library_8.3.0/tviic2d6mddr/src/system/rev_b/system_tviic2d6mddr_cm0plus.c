...
void SystemInit (void)
{
    ...
    struct {cy_en_hf_clk_dividers_t targetDiv; cy_en_hf_clk_sources_t source;} clkHfSetting[SRSS_NUM_HFROOT] = 
    {
        ...
        { .targetDiv = CY_SYSCLK_HFCLK_DIVIDE_BY_8, .source = CY_SYSCLK_HFCLK_IN_CLKPATH2 /* PLL1: PLL400#1 */ }, // setting for clk_hf5
        ...
        { .targetDiv = CY_SYSCLK_HFCLK_DIVIDE_BY_2, .source = CY_SYSCLK_HFCLK_IN_CLKPATH7 /* PLL6: PLL200#1 */ }, // setting for clk_hf13
