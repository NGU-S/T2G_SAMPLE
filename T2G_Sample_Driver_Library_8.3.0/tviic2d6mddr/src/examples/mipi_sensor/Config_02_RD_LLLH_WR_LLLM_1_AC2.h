...
*   $Date: 2023-05-02 15:09:49 +0530 (Tue, 02 May 2023) $
*   $Revision: 323030 $
*
...
#ifndef CONFIG_02_RD_LLLH_WR_LLLM_1_AC2_H_INCLUDED
#define CONFIG_02_RD_LLLH_WR_LLLM_1_AC2_H_INCLUDED

#include "drivers/lpddr4/cy_en_lpddr4.h"

#define SVN_REV_LPDDR4_CONFIG_FILE          "$Date: 2023-05-02 15:09:49 +0530 (Tue, 02 May 2023) $"
#define SVN_DATE_LPDDR4_CONFIG_FILE         "$Revision: 323030 $"
#define SVN_LPDDR4_CONFIG_FILE_NAME         "Config_02_RD_LLLH_WR_LLLM_1_AC2.h"
#define LPDDR4_CONFIG_TYPE                  "Manual Configuration"
...
{ 
    ...
    .pllconfig =
    {
        ...
        .unlockerr      = CY_LPDDR4_PLL_UNLOCK_ERROR_ENABLE,        /*   */
    ...
    { 
        ...
        .u3FS1_CAODT = CY_LPDDR4_ODT_RZQ_DIV_4                  /*  CA bus receiver on-die termination for FSP[1] */
    }, 
    ...
    { 
        ...
        #if((DIOR_ODT_ON_OFF_STATE == DIOR_ODT_STATE_OFF))
        .u3FS1_SOCODT = CY_LPDDR4_SOCODT_DISABLE,         /*  SoC ODT. Controller ODT value for VOH calibration for frequency set 1 */
        #elif((DIOR_ODT_ON_OFF_STATE == DIOR_ODT_STATE_ON) && (DIOR_ODT_VALUE == DIOR_ODT_RTT_SEL_240R))
            .u3FS1_SOCODT = CY_LPDDR4_SOCODT_RZQ_DIV_1,
        #elif((DIOR_ODT_ON_OFF_STATE == DIOR_ODT_STATE_ON) && (DIOR_ODT_VALUE == DIOR_ODT_RTT_SEL_120R))
            .u3FS1_SOCODT = CY_LPDDR4_SOCODT_RZQ_DIV_2,
        #elif((DIOR_ODT_ON_OFF_STATE == DIOR_ODT_STATE_ON) && (DIOR_ODT_VALUE == DIOR_ODT_RTT_SEL_80R))
            .u3FS1_SOCODT = CY_LPDDR4_SOCODT_RZQ_DIV_3,
        #elif((DIOR_ODT_ON_OFF_STATE == DIOR_ODT_STATE_ON) && (DIOR_ODT_VALUE == DIOR_ODT_RTT_SEL_60R))
            .u3FS1_SOCODT = CY_LPDDR4_SOCODT_RZQ_DIV_4,
        #elif((DIOR_ODT_ON_OFF_STATE == DIOR_ODT_STATE_ON) && (DIOR_ODT_VALUE == DIOR_ODT_RTT_SEL_48R))
        	.u3FS1_SOCODT = CY_LPDDR4_SOCODT_RZQ_DIV_5,
        #elif((DIOR_ODT_ON_OFF_STATE == DIOR_ODT_STATE_ON) && (DIOR_ODT_VALUE == DIOR_ODT_RTT_SEL_40R))
            .u3FS1_SOCODT = CY_LPDDR4_SOCODT_RZQ_DIV_6,
        #endif
    ...
    .unVTGC.stcField = 
    {
        .u1IVREFR = CY_LPDDR4_VTGC_IVREFR_RANGE0,       /*  set VREF Range 0  */
    ...
    .unTREG15.stcField = 
    {
        /* =tVRCG_ENABLE + 3 JEDEC Spec p.158 Table 17 max tVRCG_ENABLE=200nsec */
        .u9T_VRCGEN = CY_LPDDR4_CLOCKCYCLES(JESD209_4B_NS_MAX_TVRCG_ENABLE,CY_LPDDR4_FSP1_FREQ) + 3,
        /* VREF high current mode disable time max =tVRCG_DISABLE + 3  */
        .u8T_VRCGDIS = CY_LPDDR4_CLOCKCYCLES(JESD209_4B_NS_MAX_TVRCG_DISABLE,CY_LPDDR4_FSP1_FREQ) + 3
    },
    ...
    .unDIOR_SL0.stcField = 
    {
        .u3DRVSEL = DIOR_DRVSEL,                    /* 3-bit value to select how many copies of driver need to be turned on. Driver Setting 
        ...
        .u1RTT_EN = DIOR_ODT_ON_OFF_STATE,          /* Enable RTT compensation switch on on-die termination resistor (RTT) on/off.*/
        .u3RTT_SEL = DIOR_ODT_VALUE,                /* rtt_sel pin is used to vary the RTT impedance when rtt_en=1 ODT = 240/(rtt_sel+1) */
    ...
    .unCIOR_CH0.stcField = 
    {
        .u3DRVSEL       =   CIOR_DRVSEL,                /*  3-bit value to select how many copies of driver need to be turned on. Driver 
