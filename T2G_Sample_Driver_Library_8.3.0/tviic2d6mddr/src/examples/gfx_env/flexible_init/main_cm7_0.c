...
//=============================================================================================
  ...
  //   or depending on the board/revision some modifications may be necessary (e.g. resistor removal to reduce stubs)    
    ...
    /* Differing from the regular jumper settings to select between SMIF0<->EMMC and SMIF1<->ETH as shown on the PCB silkscreen:
       - Remove J139 and J140, short J139-1 and J140-2 with a jumper (pins may need to be bended a little)
       - Remove J152 and J153, short J152-3 and J153-2 with a jumper (pins may need to be bended a little)
       - Remove J151 and R900, short J151-2 and R900-1
    */
    #define SMIF0_EXT_FREQ_MHZ      166
    #define SMIF1_EXT_FREQ_MHZ      166
...
#define EXTMEM_RAM_BASE             0xd0000000
