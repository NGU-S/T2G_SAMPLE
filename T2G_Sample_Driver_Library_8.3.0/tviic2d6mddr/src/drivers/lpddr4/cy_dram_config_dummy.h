...
*   $Date: 2024-02-28 14:06:33 -0800 (Wed, 28 Feb 2024) $
*   $Revision: 327834 $
*
...
#define SVN_REV_CY_DRAM_CONFIG_DUMMY_H         "$Revision: 327834 $"
#define SVN_DATE_CY_DRAM_CONFIG_DUMMY_H        "$Date: 2024-02-28 14:06:33 -0800 (Wed, 28 Feb 2024) $"
...
#define SAT_SEPARATE_DM_SHMOO        0
...
#define SIZE_32_BYTE         32
#define SIZE_64_BYTE         64
#define SIZE_128_BYTE       128
#define SIZE_256_BYTE       256
#define SIZE_512_BYTE       512

#define BUFFER_SIZE        SIZE_512_BYTE             //<--- select pattern size used for SW aided training

/* comment out the next line if you want to skip printing the shmoo result on UART */
#define UART_PRINT_SHMOO    1                       //<--- 0 = UART debug print off 
...
#define SAT_READ_DLL_RANGE_STOP                 65
...
#define SAT_WRITE_VREF_RANGE_LOW                5
#define SAT_WRITE_VREF_STEPSIZE                 2    
#define SAT_WRITE_VREF_STEPS                    22

/* defines de-skewing range for write direction in dll steps */
#define SAT_WRITE_DLL_RANGE_START               20
#define SAT_WRITE_DLL_RANGE_STOP                115
