/***************************************************************************//**
* \file cy_lpddr4.h
*   $Date: 2024-09-20 00:08:02 -0700 (Fri, 20 Sep 2024) $
*   $Revision: 331745 $
*
...
#define SVN_REV_CY_LPDDR4_H "$Revision: 331745 $"
#define SVN_DATE_CY_LPDDR4_H "$Date: 2024-09-20 00:08:02 -0700 (Fri, 20 Sep 2024) $"
...
#define CY_LPDDR4_DRV_VERSION_MAJOR 3
/** Driver minor version */
#define CY_LPDDR4_DRV_VERSION_MINOR 2
...
#if (CY_USE_PSVP == 1)
    #define CPUSS_AXI_FREQUENCY (20000000)   // Hz
    #define VIDEOSS_AXI_FREQUENCY (26600000) // Hz
#else
    #define CPUSS_AXI_FREQUENCY (200000000)   // Hz
    #define VIDEOSS_AXI_FREQUENCY (266000000) // Hz
#endif
...
/** 200 ps tDQS2DQ minimum */
#define JESD209_4B_NS_TDQS2DQ_MIN     0.2      

/** 800 ps tDQS2DQ maximum */
#define JESD209_4B_NS_TDQS2DQ_MAX     0.8  
...
/* Enum definition for the software aided training */
typedef enum
{
    LPDDR4_SAT_READ         = 1u, /* memory read operation */
    LPDDR4_SAT_WRITE        = 2u, /* memory read operation */
} en_lpddr_sat_op_type;
...
typedef enum
{
    CY_LPDDR4_PLL_UNLOCK_ERROR_DISABLE = 0u, /*!< no error is issued when PLL unlocks */
    CY_LPDDR4_PLL_UNLOCK_ERROR_ENABLE = 1u   /*!< error is issued when PLL unlocks */
} cy_en_lpddr4_pll_800M_unlockerr_t;


/* Enum definition for the software aided training direction */
typedef enum
{
    LPDDR_SAT_READ         = 0u, /* memory read operation */
    LPDDR_SAT_WRITE        = 1u, /* memory write operation */
} cy_en_lpddr_sat_dir_type;
...
typedef enum
{
    ...
    CY_LPDDR4_CNTRL_GSM_STATE_POWERDOWN = 3u,       /*!< LPDDR4 controller in "POWER DOWN" state */
    CY_LPDDR4_CNTRL_GSM_STATE_PHY_OPERATION = 4u    /*!< LPDDR4 controller in "PHY Operation Mode" state*/
...
/**
 *  \enum   cy_en_lpddr4_mr5_manufactor_id_t
 *  \brief  Mode Register 5 Manufacturer ID Refer Spec. JEP166E
 */
typedef enum
{
    RESERVED = 0x00,     /*!< 0000 0000B : Reserved */
    SAMSUNG = 0x01,      /*!< 0000 0001B : Samsung */
    NANYA = 0x05,        /*!< 0000 0101B : Nanya */
    HYNIX = 0x06,        /*!< 0000 0110B : SK hynix */
    WINBOND = 0x08,      /*!< 0000 1000B : Winbond */
    ESMT = 0x09,         /*!< 0000 1001B : ESMT */
    CXMT = 0x13,         /*!< 0001 0011B : CXMT */
    UNI_IC = 0x1A,       /*!< 0001 1010B : Xi'an UniIC Semiconductors Co. Ltd */
    ISSI = 0x1B,         /*!< 0001 1011B : ISSI */
    JSC = 0x1C,          /*!< 0001 1100B : JSC */
    SINKER = 0xC5,       /*!< 1100 0101B : SINKER */
    DOSILICON = 0xE5,    /*!< 1110 0101B : Dosilicon Co,Ltd. */
    FIDELIX = 0xF8,      /*!< 1111 1000B : Fidelix */
    ULTRA_MEMORY = 0xF9, /*!< 1111 1001B : Ultra Memory */
    AP_MEMORY = 0xFD,    /*!< 1111 1101B : AP Memory */
    MICRON = 0xFF        /*!< 1111 1111B : Micron */
} cy_en_lpddr4_mr5_manufactor_id_t;
...
typedef struct
{
    ...
    cy_en_lpddr4_pll_800M_unlockerr_t unlockerr;       /*!< error on PLL unlock */
...
/**
 *  \enum   cy_en_lpddr4_mr8_type_t
 *  \brief  LPDDR4 MR8 type definitions.
 */
typedef enum
{
    S16_SDRAM = 0x0, /*!< S16 SDRAM (16n pre-fetch) */
} cy_en_lpddr4_mr8_type_t;

/**
 *  \enum   cy_en_lpddr4_mr8_density_t
 *  \brief  LPDDR4 MR8 densitydefinitions.
 */
typedef enum
{
    CHANNEL_DENSITY_2GB = 0x0,  /*<! 0000B : 4Gb dual channel die / 2Gb single channel die */
    CHANNEL_DENSITY_3GB = 0x1,  /*<! 0001B : 6Gb dual channel die / 3Gb single channel die */
    CHANNEL_DENSITY_4GB = 0x2,  /*<! 0010B : 8Gb dual channel die / 4Gb single channel die */
    CHANNEL_DENSITY_6GB = 0x3,  /*<! 0011B : 12Gb dual channel die / 6Gb single channel die */
    CHANNEL_DENSITY_8GB = 0x4,  /*<! 0100B : 16Gb dual channel die / 8Gb single channel die */
    CHANNEL_DENSITY_12GB = 0x5, /*<! 0101B : 24Gb dual channel die / 12Gb single channel die */
    CHANNEL_DENSITY_16GB = 0x6, /*<! 0110B : 32Gb dual channel die / 16Gb single channel die */
    CHANNEL_DENSITY_1GB = 0x7   /*<! 1100B : 2Gb dual channel die / 1Gb single channel die */
} cy_en_lpddr4_mr8_density_t;

/**
 *  \enum   cy_en_lpddr4_mr8_iowidth_t
 *  \brief  LPDDR4 MR8 io width .
 */
typedef enum
{
    X16 = 0x00, /*<! 00B : x16 (per channel) */
} cy_en_lpddr4_mr8_iowidth_t;

/**
 * \brief structure for DRAM Mode Register 8
 */
typedef struct cy_stc_LPDDR4_DRAM_MR8_field
{
    cy_en_lpddr4_mr8_type_t type : 2;       /*!< type */
    cy_en_lpddr4_mr8_density_t density : 4; /*!< density */
    cy_en_lpddr4_mr8_iowidth_t iowidth : 2; /*!< IO width */
} cy_stc_LPDDR4_DRAM_MR8_field_t;

/**
 *  \brief union DRAM Mode Register 8
 */
typedef union un_dram_mr8
{
    cy_stc_LPDDR4_DRAM_MR8_field_t stcField; /*!< stcField for Bitfield access */
...
{
    cy_stc_LPDDR4_DRAM_MR4_field_t stcField; /*!< stcField for Bitfield access */
    uint8_t byteValue;                       /*!< byteValue for byte wise access */
} un_dram_mr4_t;
...
/** \brief  struct holding the dlltab step size in case of manually updating the
 *          dll lines instead of performing re-training (experimental)
 *          It´s recommended to perform automatic DQS2DQ re-training using
 *          Cy_Lpddr_RequestDQS2DQRetrain().
 */
typedef struct
{
    uint32_t CHA; /*!< manual DQS2DQ update dll tabs for CHA */
    uint32_t CHB; /*!< manual DQS2DQ update dll tabs for CHB */
} cy_stc_lpddr4_manupd_dlltabs_t;
...
/** \brief struct to catch DQS2DQ value for each channel*/
typedef struct
{
    double value_CHA; /*!< tDQS2DQ of CHA */
    double value_CHB; /*!< tDQS2DQ of CHB */
} cy_stc_lpddr4_tdqs2dq_t;

/** \brief allowed timing skew above a retraining will be triggered*/
typedef struct
{
    uint32_t CHA; /*!< allowed timing skew in dll steps for CHA */
    uint32_t CHB; /*!< allowed timing skew in dll steps for CHB */
} cy_stc_lpddr4_skew_in_dllsteps_t;
...
typedef struct
{
    ...
    uint32_t allowedDLLSkew[2]; /*!< allowed skew in dll tabs before DQS2DQ re-training gets triggered
                                     resolution 1/(FSP[1]*127) as the dll has 7 tabs.*/
    ...
    un_LPDDR4_LPDDR4_CORE_INECC0_t unINECC0;             /*!<Inline ECC Register 0  ECC Region Base Address */
    un_LPDDR4_LPDDR4_CORE_INECC1_t unINECC1;             /*!<Inline ECC Register 1  ECC Protected Region Base Address */
    un_LPDDR4_LPDDR4_CORE_INECC2_t unINECC2;             /*!<Inline ECC Register 2  Protected Region Size */
    #ifdef CY_MCU_rev_b
        un_LPDDR4_LPDDR4_CORE_DMCTL1_t unDMCTL1;             /*!<Dynamo Control Register 1*/ 
    #endif
 ...
 * </ul>
 **/
typedef struct stc_LPDDR4_training_status_field {
    uint32_t InitialTrainingERR : 1;
    uint32_t VREFDQRDERR : 1;
    uint32_t VREFCAERR : 1;
    uint32_t GTERR : 1;
    uint32_t WRLVLERR : 1;
    uint32_t RDLVLERR : 1;
    uint32_t VREFDQWRERR : 1;
    uint32_t SANCHKERR : 1;
    uint32_t RetrainERR : 1;
    uint32_t DQSDQERR : 1;
    uint32_t InitialTrainingsPassedOK : 1;
    uint32_t VREFDQRDTrainingPassedOK : 1;
    uint32_t CommandBusTrainingPassedOK : 1;
    uint32_t GateTrainingPassedOK : 1;
    uint32_t WriteLevelingPassedOK : 1;
    uint32_t ReadLevelingPassedOK : 1;
    uint32_t VREFDQWRTrainingPassedOK : 1;
    uint32_t ReloadInitPassedOK : 1;
    uint32_t DQS2DQReTrainingPassedOK : 1;
    uint32_t SanityCheckPassedOK : 1;
    uint32_t : 12;
} stc_LPDDR4_training_status_field_t;

typedef union un_LPDDR4_Training_Status {
    uint32_t u32Register;
    stc_LPDDR4_training_status_field_t stcField;
    uint8_t au8Byte[4];
    uint16_t au16Halfword[2];
} un_LPDDR4_Training_Status_t;

typedef void (*ptrCallbackFunc)(void);
...
typedef struct
{
    ...
    cy_en_lpddr4_cntrl_init_state_t controllerInitState;
    ...
    cy_en_lpddr4_chan_sel_t channelActive;
    /* DDR Device Manufacturer */
    cy_en_lpddr4_mr5_manufactor_id_t manufacturerCHA;
    /* DDR Device Manufacturer */
    cy_en_lpddr4_mr5_manufactor_id_t manufacturerCHB;
    /* DDR Memory Density per Channel */
    cy_en_lpddr4_mr8_density_t channelDensityCHA;
    /* DDR Memory Density per Channel */
    cy_en_lpddr4_mr8_density_t channelDensityCHB;
    /*!<flag signaling if a DQS2DQ retraining is needed for CHA */
    bool retrainRequestCHA;
    /*!<flag signaling if a DQS2DQ retraining is needed for CHB */
    bool retrainRequestCHB;
    /*!<struct contains the DQS Counter Value after last successfull
    training for CHA and CHB */
    cy_stc_lpddr4_dqsosc_read_data_t dqsOSCCountLastTraining;
    /*!<struct contains the DQS Counter Value for CHA/B which triggered
    current training */
    cy_stc_lpddr4_dqsosc_read_data_t dqsOSCCountTrigTrain;
    /*!<struct contains the actual DQS Counter Value for CHA/B */
    cy_stc_lpddr4_dqsosc_read_data_t actualDQSOsc;
    /* tDQS2DQ at last training */
    cy_stc_lpddr4_tdqs2dq_t tDQS2DQ_lasttrain;
    /* tDQS2DQ at last training */
    cy_stc_lpddr4_tdqs2dq_t tDQS2DQ_actual;
    /* allowed timing skew in s*/
    cy_stc_lpddr4_tdqs2dq_t allowedTimingSkew;
    /* allowed timing skew before re-training is triggered */
    cy_stc_lpddr4_skew_in_dllsteps_t allowedSkewInDLLSteps;
    /* actual delta tDQS2DQ */
    cy_stc_lpddr4_tdqs2dq_t actDeltatDQS2DQ;
    /* actual delta tDQS2DQ */
    cy_stc_lpddr4_tdqs2dq_t tDQS2DQ_TrigTrain;
    /*!<the direction for the next DQS2DQ training */
    cy_en_lpddr4_dqsdqcr_dir_t retrainDirection;
    /*!<status if a DQS2DQ re-training is active or not.
    Is active, if at least 1 channels has a training active  */
    bool dqs2dqRetrainActive;
    /*!<status if controller is running or not */
    cy_en_lpddr4_cntrl_run_state_t controllerRunning;
    /* previous Controller statemaschine state */
    cy_en_lpddr4_cntrl_gsm_state_t controllerStatePrevRecov;
    /* previous Controller statemaschine state */
    cy_en_lpddr4_cntrl_gsm_state_t controllerStatePrev;
    /* actual Controller statemaschine state */
    cy_en_lpddr4_cntrl_gsm_state_t controllerState;
    /*!< status if temperature derating is active. detail about derating refer
    JEDEC209-4B  10.3 Temperature Derating for AC timing */
    cy_en_lpddr4_MR4_derate_state_t deratingStatus;
    /*  flag signaling that a timing derating is pending. During next MC stop
    the parameters will be changed accordingly. */
    cy_en_lpddr4_MR4_derate_state_t deratingPending;
    /*!< external Memory temperature state from MR4[2:0] */
    cy_en_lpddr4_memory_operational_temperature_t operationTemperatureState;
    /*!< last command send over UCI Register to the controller */
    un_LPDDR4_LPDDR4_CORE_UCI_t lastUCICommand;
    /*!< actual refresh rate setting */
    cy_en_lpddr4_refresh_rate_t refreshRate;
    ...
    cy_en_lpddr4_refreshrate_strategy_t refreshRateStrategy;
    /*!< driver context information of actual selected timing derating strategy */
    cy_en_deratingstrategy_state_t timingDeratingStrategy;
    ...
    cy_en_refreshrate_strategy_change_state_t refreshStrategyChanged;
    un_LPDDR4_Training_Status_t trainingStatus;
    /*!< the fixed user refresh rate the user has given in the lpddr4 config structure */
    uint32_t fixedUserRefreshRate;
    /* counts the number of DQS2DQ events*/
    uint32_t dqs2dqRetrainEvents;
    /*FSP[0] frequency*/
    double freqFSP0;
    /*FSP[1] frequency*/
    double freqFSP1;
    /* DQS OSC Runtime in [s]*/
    double dqsOSCRuntime;
    /* dll steps needed for correcting skew caused by PVT */
    cy_stc_lpddr4_manupd_dlltabs_t manDQS2DQCorrection;
    /* flag signaling if tDQS2DQ CHA is within JEDEC limits */
    bool btDQS2DQ_OOR_CHA;
    /* flag signaling if tDQS2DQ CHB is within JEDEC limits */
    bool btDQS2DQ_OOR_CHB;
    /* callback function.User can register a callback function which will
    run once during vertical blanking. If function has ended the ptrCallbackFunc will be
    reset to NULL. Can be used to change controller settings during Vertical Blanking interval */
    ptrCallbackFunc callback;
} cy_stc_lpddr4_context_t;

// typedef struct
// {
//     /* PTSRx re-train result */
//     un_LPDDR4_LPDDR4_CORE_PTSR5_t ptsr5;
//     // stc_LPDDR4_LPDDR4_CORE_PTSR5_field_t ptsr5res;
//     un_LPDDR4_LPDDR4_CORE_PTSR6_t ptsr6;
//     un_LPDDR4_LPDDR4_CORE_PTSR7_t ptsr7;
//     un_LPDDR4_LPDDR4_CORE_PTSR8_t ptsr8;
//     un_LPDDR4_LPDDR4_CORE_PTSR9_t ptsr9;
//     un_LPDDR4_LPDDR4_CORE_PTSR10_t ptsr10;
//     un_LPDDR4_LPDDR4_CORE_PTSR11_t ptsr11;
//     un_LPDDR4_LPDDR4_CORE_PTSR12_t ptsr12;
//     un_LPDDR4_LPDDR4_CORE_PTSR13_t ptsr13;
//     /*!<struct contains the DQS Counter Value after last successfull
//     training for CHA and CHB */
//     cy_stc_lpddr4_dqsosc_read_data_t dqsOSCCountLastTraining;
//     /*!<struct contains the DQS Counter Value for CHA/B which triggered
...
//     /*!<struct contains the actual DQS Counter Value for CHA/B */
//     cy_stc_lpddr4_dqsosc_read_data_t actualDQSOsc;
//     float retrainduration;
//     bool initialTraining;
//     /*!<the direction for the next DQS2DQ training */
//     cy_en_lpddr4_dqsdqcr_dir_t retrainDirection;
//     /* counts the number of DQS2DQ events*/
//     uint32_t dqs2dqRetrainEvent;
// } cy_lpddr4_retrainresultlog_t;

    /* AXI Perf Count Config struct */

/**
 * \brief AXI Performance Counter Measureing Unit Configuration Structure
 **/
typedef struct
{
...
extern volatile cy_stc_lpddr4_context_t g_stc_lpddr_context;
 ...
 *  this function can be used to anually update the DLL in PTSR5..13 and run
 *  a reload to get the controller PHY updated.
 *  It´s recommended to stick with automatic re-training.
 *
 *  \return \ref cy_en_lpddr4_retval_t<br>
 *  CY_LPDDR4_BAD_PARAM - if a bad parameter was passed to the function<br>
 *  CY_LPDDR4_SUCCESS   - if everything was ok<br>
...
/*******************************************************************************
 *  Function Name:  Cy_LPDDR_CorrectSECECCFaults
 *************************************************************************//****
 *  \brief  This function is used to correct SEC ECC error in the DRAM
 *
 * Function as long as SEC Errors are present the function read the correted values
 * and write them back to DRAM
 *
 *  \param  none
 *
 *  \return none
...
/*******************************************************************************
 *  Function Name: Cy_Lpddr4_GetAXIPerfCntMUxActPortCfg
 ***************************************************************************//**
 *  \brief Function to read the actual Port_Select information from a measuring
 *         unit (MU), MU with index muIDX
 *
 *  \param base Pointer to the LPDDR4 Base Structure from type \ref stc_LPDDR4_t
 *
 *  \param muIdx index of the Measuring Unit . First MU has index 0 last MU has index
 *         LPDDR4_AXI_PERF_CNT_MU_NR - 1.
 *
 * \return uint32_t current MU Port Select setting of selected MU
 *
 ******************************************************************************/
__INLINE uint32_t Cy_Lpddr4_GetAXIPerfCntMUxActPortCfg(volatile stc_LPDDR4_t *base,
                                                       uint32_t muIdx)
{
    return ((uint32_t)base->AXI_PERF_CNT.MU[muIdx].unPORT_SELECT.stcField.u3SELECT);
}

/*******************************************************************************
 *  Function Name: Cy_Lpddr4_GetAXIPerfCntMUxActDIRCfg
 ***************************************************************************//**
 *  \brief Function to read the actual direcetion setting from a measuring
 *         unit (MU), MU with index muIDX
 *
 *  \param base Pointer to the LPDDR4 Base Structure from type \ref stc_LPDDR4_t
 *
 ...
 *         LPDDR4_AXI_PERF_CNT_MU_NR - 1.
 *
 * \return uint32_t current MU direction setting of selected MU
 *
 ******************************************************************************/
__INLINE uint32_t Cy_Lpddr4_GetAXIPerfCntMUxActDIRCfg(volatile stc_LPDDR4_t *base,
                                                      uint32_t muIdx)
{
    return ((uint32_t)base->AXI_PERF_CNT.MU[muIdx].unFILTER.stcField.u1WRITE);
}

/*******************************************************************************
 *  Function Name: Cy_Lpddr4_GetAXIPerfCntMUxActTMRCfg
 ***************************************************************************//**
 *  \brief Function to read the actual TMR setting from a measuring
 *         unit (MU), MU with index muIDX
 *
 *  \param base Pointer to the LPDDR4 Base Structure from type \ref stc_LPDDR4_t
 *
 ...
 *         LPDDR4_AXI_PERF_CNT_MU_NR - 1.
 *
 * \return uint32_t current TMR setting of selected MU
 *
 ******************************************************************************/
__INLINE uint32_t Cy_Lpddr4_GetAXIPerfCntMUxActTMRCfg(volatile stc_LPDDR4_t *base,
                                                      uint32_t muIdx)
{
    return ((uint32_t)base->AXI_PERF_CNT.MU[muIdx].unTMR_CTL.stcField.u28TMR);
}

/*******************************************************************************
 *  Function Name: Cy_Lpddr4_GetAXIPerfCntMUxActPSCCfg
 ***************************************************************************//**
 *  \brief Function to read the actual PSC setting from a measuring
 *         unit (MU), MU with index muIDX
 *
 *  \param base Pointer to the LPDDR4 Base Structure from type \ref stc_LPDDR4_t
 *
 ...
 *         LPDDR4_AXI_PERF_CNT_MU_NR - 1.
 *
 * \return uint32_t current PSC setting of selected MU
 *
 ******************************************************************************/
__INLINE uint32_t Cy_Lpddr4_GetAXIPerfCntMUxActPSCCfg(volatile stc_LPDDR4_t *base,
                                                      uint32_t muIdx)
{
    return ((uint32_t)base->AXI_PERF_CNT.MU[muIdx].unTMR_CTL.stcField.u4PSC);
}

/*******************************************************************************
 *  Function Name: Cy_Lpddr4_GetAXIPerfCntMUxTMR_CTL
 ***************************************************************************//**
 *  \brief Function to read the actual TMR_CTL from a measuring
 *         unit (MU), MU with index muIDX
 *
 *  \param base Pointer to the LPDDR4 Base Structure from type \ref stc_LPDDR4_t
 *
 ...
 *         LPDDR4_AXI_PERF_CNT_MU_NR - 1.
 *
 * \return uint32_t current TMR_CTL Register setting of selected MU
 *
 ******************************************************************************/
__INLINE uint32_t Cy_Lpddr4_GetAXIPerfCntMUxTMR_CTL(volatile stc_LPDDR4_t *base,
                                                    uint32_t muIdx)
{
    return base->AXI_PERF_CNT.MU[muIdx].unTMR_CTL.u32Register;
}
/*******************************************************************************
 *  Function Name: Cy_Lpddr4_GetAXIPerfCntMURuntime
 ***************************************************************************//**
 *  \brief Function to read the actual configured runtime of a measuring
 *         unit (MU), MU with index muIDX
 *
 *  \param base Pointer to the LPDDR4 Base Structure from type \ref stc_LPDDR4_t
 *
 ...
 *         LPDDR4_AXI_PERF_CNT_MU_NR - 1.
 *
 * \return float actual configured MU runtime [s]
 *
 ******************************************************************************/
__INLINE float Cy_Lpddr4_GetAXIPerfCntMURuntime(volatile stc_LPDDR4_t *base, uint32_t muIdx)
{
    uint32_t tmr = base->AXI_PERF_CNT.MU[muIdx].unTMR_CTL.stcField.u28TMR;
    uint32_t psc = base->AXI_PERF_CNT.MU[muIdx].unTMR_CTL.stcField.u4PSC;
    uint32_t port = base->AXI_PERF_CNT.MU[muIdx].unPORT_SELECT.stcField.u3SELECT;
    uint32_t freq = 0;
    freq = (port > 0) ? VIDEOSS_AXI_FREQUENCY : CPUSS_AXI_FREQUENCY;
    float runtime = (1.0 / freq) * tmr * powf(2, psc);
    return runtime;
}
