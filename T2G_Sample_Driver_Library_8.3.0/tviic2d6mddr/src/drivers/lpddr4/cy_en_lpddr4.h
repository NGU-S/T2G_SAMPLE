/***************************************************************************
* \file cy_en_lpddr4.h
*   $Date: 2024-06-25 03:42:51 -0700 (Tue, 25 Jun 2024) $
*   $Revision: 329995 $
*
...
#define SVN_REV_CY_EN_LPDDR4_H         "$Revision: 329995 $"
#define SVN_DATE_CY_EN_LPDDR4_H        "$Date: 2024-06-25 03:42:51 -0700 (Tue, 25 Jun 2024) $"
...
/* rd /wr shmoo dll timing skew signal select */
typedef enum {
    CY_LPDDR4_COMBINED_SHMOO    = 0x0, /**< all signals DM + DQ are shmooed */
    CY_LPDDR4_DM_SHMOO          = 0x1, /**< only DM signals are shmooed */
    CY_LPDDR4_DQ_SHMOO          = 0x2  /**< only DQx are shmooed  */
} cy_en_lpddr4_rdwr_dllupd_t;
...
/* RTT impedance when rtt_en=1. */
typedef enum {
    CY_LPDDR4_RTT_SEL_RTT240 = 0x0, /**< RTT = 240Ohm */
    CY_LPDDR4_RTT_SEL_RTT120 = 0x1, /**< RTT = 120Ohm */
    CY_LPDDR4_RTT_SEL_RTT80 = 0x2,  /**< RTT = 80Ohm */
    CY_LPDDR4_RTT_SEL_RTT60 = 0x3,  /**< RTT = 60Ohm */
    CY_LPDDR4_RTT_SEL_RTT48 = 0x4,  /**< RTT = 48Ohm */
    CY_LPDDR4_RTT_SEL_RTT40 = 0x5   /**< RTT = 40Ohm */
...
typedef enum {
    ...
    CY_LPDDR4_UCI_CMD_OP_USER_CMD_PHYOPE = 0xE, /**< Start Phy Operation */
    CY_LPDDR4_UCI_CMD_OP_USER_CMD_PHYOPX = 0xF  /**< Stop PHY Operation */
...
typedef enum {
    CY_LPDDR4_VTGC_IVREFR_RANGE0 = 0,
