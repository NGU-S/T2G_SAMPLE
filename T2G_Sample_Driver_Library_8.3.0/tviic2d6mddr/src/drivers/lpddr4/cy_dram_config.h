...
*   $Date: 2024-09-16 01:57:30 -0700 (Mon, 16 Sep 2024) $
*   $Revision: 331655 $
*
...
#define SVN_REV_CY_DRAM_CONFIG_H           "$Revision: 331655 $"
#define SVN_DATE_CY_DRAM_CONFIG_H        "$Date: 2024-09-16 01:57:30 -0700 (Mon, 16 Sep 2024) $"
...
/* ______ _____ _____             _     _                          _   _   _
  |  ____/ ____/ ____|           | |   | |                        | | | | (_)
  | |__ | |   | |        __ _  __| | __| |_ __ ___  ___   ___  ___| |_| |_ _ _ __   __ _ ___ 
  |  __|| |   | |       / _` |/ _` |/ _` | '__/ _ \/ __| / __|/ _ \ __| __| | '_ \ / _` / __|
  | |___| |___| |____  | (_| | (_| | (_| | | |  __/\__ \ \__ \  __/ |_| |_| | | | | (_| \__ \
  |______\_____\_____|  \__,_|\__,_|\__,_|_|  \___||___/ |___/\___|\__|\__|_|_| |_|\__, |___/
                                                                                    __/ |
                                                                                   |___/ */
#define ECC_ADDRESS_INFORMATION_FROM_CONFIG     0       // ECC address informations are used as set in the confguration
#define ECC_ADDRESS_INFORMATION_FROM_LINKER     1       // ECC address information from linker file is used
                                                        // Linker file must provide the following information
                                                        //           __extlp4dram_pr_base
                                                        //           __extlp4dram_pr_size
                                                        //           __extlp4dram_ecc_code_base
#define ECC_USE_LINKER_ADDRESSES        ECC_ADDRESS_INFORMATION_FROM_LINKER     //<-- select ECC Address information source
...
#define USE_PLL_FREQ_648        5
#define USE_PLL_FREQ_650p67     6
#define USE_PLL_FREQ_652        7
#define USE_PLL_FREQ_696        8
#define USE_PLL_FREQ_720        9
#define USE_PLL_FREQ_736        10
#define USE_PLL_FREQ_744        11
#define USE_PLL_FREQ_752        12
#define USE_PLL_FREQ_800        13
...
/*LPDDR4 PLL Settings */
    //FSP[0]=44.44 MHz  and FSP[1]= 400 MHz
        ...
        #define LPDDR4_PLL_OUT_DIV_FSP0     9          //  OutPut Divider for FSP[0] frequency             <--set PLL Output Divder for FSP[0]
                                                        //  valid values 2..16 
        #define LPDDR4_PLL_OUT_DIV_FSP1     9          //  OUTPUT_DIV for FSP[1] is actually don´t         <-- set PLL Output Divder for FSP[1]
                                                        //  (this is actually a don´t care) might be deleted later valid values 2..16 
    #endif

    //FSP[0]=45.09 MHz  and FSP[1]= 496 MHz
    ...
    //FSP[0]=54.55 MHz  and FSP[1]= 600 MHz
        ...
        #define LPDDR4_PLL_OUT_DIV_FSP1     11          //  OUTPUT_DIV for FSP[1] is actually don´t         <-- set PLL Output Divder for FSP[1]
                                                        //  (this is actually a don´t care) might be deleted later valid values 2..16 
    #endif
    //FSP[0]=49.85 MHz  and FSP[1]= 648 MHz
    #if (USE_PLL_FREQ_MHZ == USE_PLL_FREQ_648)
        #define LPDDR4_PLL_FIN_HZ           16000000    //  PLL Input Frequency (CLK_HF14 )                 <--set PLL input freq.
        #define LPDDR4_PLL_REF_DIV          2           //  PLL Reference Divider  valid values 1..18       <--set PLL Reference Divider 
        #define LPDDR4_PLL_FDBK_DIV         81          //  PLL  Feedback Divider  valid values 16..200     <--set PLL Fdbk Divider 
    ...
    //FSP[0]=50.05 MHz  and FSP[1]= 650.67 MHz
    #if (USE_PLL_FREQ_MHZ == USE_PLL_FREQ_650p67)
        #define LPDDR4_PLL_FIN_HZ           16000000    //  PLL Input Frequency (CLK_HF14 )                 <--set PLL input freq.
        #define LPDDR4_PLL_REF_DIV          3           //  PLL Reference Divider  valid values 1..18       <--set PLL Reference Divider 
        #define LPDDR4_PLL_FDBK_DIV         122         //  PLL  Feedback Divider  valid values 16..200     <--set PLL Fdbk Divider 
        #define LPDDR4_PLL_OUT_DIV_FSP0     13          //  OutPut Divider for FSP[0] frequency             <--set PLL Output Divder for FSP[0]
                                                        //  valid values 2..16 
        #define LPDDR4_PLL_OUT_DIV_FSP1     13          //  OUTPUT_DIV for FSP[1] is actually don´t         <-- set PLL Output Divder for FSP[1]
                                                        //  (this is actually a don´t care) might be deleted later valid values 2..16 
    ...
    //FSP[0]=50.15 MHz  and FSP[1]= 652 MHz
    #if (USE_PLL_FREQ_MHZ == USE_PLL_FREQ_652)
        #define LPDDR4_PLL_FIN_HZ           16000000    //  PLL Input Frequency (CLK_HF14 )                 <--set PLL input freq.
        #define LPDDR4_PLL_REF_DIV          4           //  PLL Reference Divider  valid values 1..18       <--set PLL Reference Divider 
        #define LPDDR4_PLL_FDBK_DIV         163         //  PLL  Feedback Divider  valid values 16..200     <--set PLL Fdbk Divider 
        #define LPDDR4_PLL_OUT_DIV_FSP0     13          //  OutPut Divider for FSP[0] frequency             <--set PLL Output Divder for FSP[0]
                                                        //  valid values 2..16 
        #define LPDDR4_PLL_OUT_DIV_FSP1     13          //  OUTPUT_DIV for FSP[1] is actually don´t         <-- set PLL Output Divder for FSP[1]
                                                        //  (this is actually a don´t care) might be deleted later valid values 2..16 
    ...
    //FSP[0]=48 MHz  and FSP[1]= 720 MHz
        ...
        #define LPDDR4_PLL_OUT_DIV_FSP0     15          //  OutPut Divider for FSP[0] frequency             <--set PLL Output Divder for FSP[0]
                                                        //  valid values 2..16 
        #define LPDDR4_PLL_OUT_DIV_FSP1     15          //  OUTPUT_DIV for FSP[1] is actually don´t         <-- set PLL Output Divder for FSP[1]
                                                        //  (this is actually a don´t care) might be deleted later valid values 2..16 
    #endif

    //FSP[0]=49.07 MHz  and FSP[1]= 736 MHz
    ...
    //FSP[0]=49.60 MHz  and FSP[1]= 744 MHz
    ...
    //FSP[0]=50.13 MHz  and FSP[1]= 752 MHz
    ...
    //FSP[0]=53.33 MHz  and FSP[1]= 800 MHz
...
/*
  _____   ____   _____ ___  _____   ____    _____             _             _       _             
 |  __ \ / __ \ / ____|__ \|  __ \ / __ \  |  __ \           | |           (_)     (_)            
 | |  | | |  | | (___    ) | |  | | |  | | | |__) |___ ______| |_ _ __ __ _ _ _ __  _ _ __   __ _ 
 | |  | | |  | |\___ \  / /| |  | | |  | | |  _  // _ \______| __| '__/ _` | | '_ \| | '_ \ / _` |
 | |__| | |__| |____) |/ /_| |__| | |__| | | | \ \  __/      | |_| | | (_| | | | | | | | | | (_| |
 |_____/ \___\_\_____/|____|_____/ \___\_\ |_|  \_\___|       \__|_|  \__,_|_|_| |_|_|_| |_|\__, |
                                                                                             __/ |
                                                                                            |___/ */
#define DQS2DQ_HW_RETRAIN       0                           /* HW Training triggered via POM register */
#define DQS2DQ_SW_UPDATED       1                           /* Delay Line Update via Software         */
#define DQS2DQ_PVT_COMPENSATE   DQS2DQ_SW_UPDATED           /*<---- make your selection */



/*  _____  _    _    ___  _     _          _   _____         _       _             
   /  ___|| |  | |  / _ \(_)   | |        | | |_   _|       (_)     (_)            
   \ `--. | |  | | / /_\ \_  __| | ___  __| |   | |_ __ __ _ _ _ __  _ _ __   __ _ 
    `--. \| |/\| | |  _  | |/ _` |/ _ \/ _` |   | | '__/ _` | | '_ \| | '_ \ / _` |
   /\__/ /\  /\  / | | | | | (_| |  __/ (_| |   | | | | (_| | | | | | | | | | (_| |
   \____/  \/  \/  \_| |_/_|\__,_|\___|\__,_|   \_/_|  \__,_|_|_| |_|_|_| |_|\__, |
                                                                              __/ |
                                                                             |___/ */

/* main enabler for SW Aided Training */
#define SAT_DISABLED        0
#define SAT_ENABLED         1
#if( CY_USE_PSVP == 0)
    #define SOFTWARE_AIDED_TRAINING       SAT_ENABLED          //<--- make your selection
#elif( CY_USE_PSVP == 1)
    /* PSVP does not support the DLL stuff so 
       SW Aided Training is not possible with PSVP */
    #define SOFTWARE_AIDED_TRAINING       SAT_DISABLED         /* PSVP does not support the DLL stuff so */
#endif
/* 
    NOTE:Software Aided Training uses AXI DMA Ch0 & Ch1 to copy data back and forth
    make sure AXI DMA is not already used for another purpose, If your application 
    needs AXI DMA you have to configure your AXI DMA after LPDDR4 Controller Initialization  
*/
/* size of the buffer used for software aided training */

#define SIZE_128_BYTE       128
#define SIZE_256_BYTE       256
#define SIZE_512_BYTE       512

#define BUFFER_SIZE        SIZE_128_BYTE             //<--- select pattern size used for SW aided training

/* comment out the next line if you want to skip printing the shmoo result on UART */
#define UART_PRINT_SHMOO    0                       //<--- 0 = UART debug print off 
                                                    //     1 = UART debug print on  (main application must take care for UART INIT)

/* VREF range selection strategies */
#define SAT_LOWER_VREF          0   /**<! if the calculated data eye width of 2 different VREF lines is equal select the lower VREF */ 
#define SAT_HIGHER_VREF         1   /**<! if the calculated data eye width of 2 different VREF lines is equal select the lower VREF */
#define SAT_MID_RANGE_VREF      2   /**<! select the VREF inside a block width same data eye width*/


/* read direction */
#define SAT_PHY_VREF_SELECT_STRATEGY    SAT_MID_RANGE_VREF      /* strategy for PHY VREF */
#define SAT_PHY_VREF_MIDRNG_STRATEGY    SAT_HIGHER_VREF         /* if MID range is selected and the # of lines width same data eye width is even
                                                                   select either the higher or lower VREF value */

/* defines the read shmoo scanning range for VREF */
#define SAT_READ_VREF_RANGE_LOW                 0
#define SAT_READ_VREF_STEPSIZE                  1
#define SAT_READ_VREF_STEPS                     50

/* defines de-skewing range for read direction in dll steps */
#define SAT_READ_DLL_RANGE_START                0
#define SAT_READ_DLL_RANGE_STOP                 127

#if(( SAT_READ_VREF_RANGE_LOW + ( SAT_READ_VREF_STEPSIZE * SAT_READ_VREF_STEPS )> 50 ))
    #warning wrong READ SHMOO configuration max VREF step is > 50 
#endif

#define VREFCODES_READ  SAT_READ_VREF_STEPS + 1 
#define DLLCODES_READ    SAT_READ_DLL_RANGE_STOP - SAT_READ_DLL_RANGE_START + 1

/**************************************************/
/** Setting for SW Aided Training Write Direction */

#define SAT_COMBINED_SHMOO              0
#define SAT_SEPARATED_DM_SHMOO          1

#define SAT_SEPARATE_DM_SHMOO   SAT_COMBINED_SHMOO

#define SAT_DRAM_VREF_SELECT_STRATEGY   SAT_MID_RANGE_VREF      /* strategy for DRAM VREF */
#define SAT_DRAM_VREF_MIDRNG_STRATEGY   SAT_HIGHER_VREF         /* if MID range is selected and the # of lines width same data eye width is even
                                                                   select either the higher or lower VREF value */

/* define the range for write training */
#define SAT_WRITE_VREF_RANGE_LOW                0
#define SAT_WRITE_VREF_STEPSIZE                 1    
#define SAT_WRITE_VREF_STEPS                    50

/* defines de-skewing range for write direction in dll steps */
#define SAT_WRITE_DLL_RANGE_START               0
#define SAT_WRITE_DLL_RANGE_STOP                127

#if(( SAT_WRITE_VREF_RANGE_LOW + ( SAT_WRITE_VREF_STEPSIZE * SAT_WRITE_VREF_STEPS )> 50 ))
    #warning wrong WRITE SHMOO configuration max VREF step is > 50 
#endif

#define VREFCODES_WRITE  SAT_WRITE_VREF_STEPS + 1
#define DLLCODES_WRITE      SAT_WRITE_DLL_RANGE_STOP - SAT_WRITE_DLL_RANGE_START + 1
...
#define FS1_WLS      WL_SET_B                       /*<---- Set Write Latency Set */
/****************************************************/
#if (FS1_WLS == WL_SET_A)
...
//    ______      __       __   ____  ____  ____  ____  ______
//   / ____/___  / /______/ /  / __ \/ __ \/ __ \/ __ \/_  __/
//  / /   / __ \/ __/ ___/ /  / / / / / / / / / / / / / / /   
// / /___/ / / / /_/ /  / /  / /_/ / /_/ / /_/ / /_/ / / /    
// \____/_/ /_/\__/_/  /_/  /_____/\___\_\____/_____/ /_/  
#define DIOR_ODT_STATE_OFF          0
#define DIOR_ODT_STATE_ON           1
#define DIOR_ODT_ON_OFF_STATE       DIOR_ODT_STATE_ON           //<---- enable /disable DQODT

//ODT = 240/(rtt_sel+1)
#define DIOR_ODT_RTT_SEL_240R       0       // RZQ/1
#define DIOR_ODT_RTT_SEL_120R       1       // RZQ/2
#define DIOR_ODT_RTT_SEL_80R        2       // RZQ/3
#define DIOR_ODT_RTT_SEL_60R        3       // RZQ/4
#define DIOR_ODT_RTT_SEL_48R        4       // RZQ/5
#define DIOR_ODT_RTT_SEL_40R        5       // RZQ/6
#define DIOR_ODT_VALUE              DIOR_ODT_RTT_SEL_48R        //<---- set DQODT value



#define DIOR_CIOR_DRVSEL_DRV1       0           /* 1 driver  */
#define DIOR_CIOR_DRVSEL_DRV2       1           /* 2 drivers */
#define DIOR_CIOR_DRVSEL_DRV3       2           /* 3 drivers */
#define DIOR_CIOR_DRVSEL_DRV4       3           /* 4 drivers */
#define DIOR_CIOR_DRVSEL_DRV5       4           /* 5 drivers */
#define DIOR_CIOR_DRVSEL_DRV6       5           /* 6 drivers */
/*
    ____  __  ___  __   ____  ____          __     _                    __                        __  __  
   / __ \/ / / | \/ /  / __ \/ __ \    ____/ /____(_)   _____     _____/ /_________  ____  ____ _/ /_/ /_ 
  / /_/ / /_/ / \  /  / / / / / / /   / __  / ___/ / | / / _ \   / ___/ __/ ___/ _ \/ __ \/ __ `/ __/ __ \
 / ____/ __  /  / /  / /_/ / /_/ /   / /_/ / /  / /| |/ /  __/  (__  ) /_/ /  /  __/ / / / /_/ / /_/ / / /
/_/   /_/ /_/  /_/  /_____/\___\_\   \__,_/_/  /_/ |___/\___/  /____/\__/_/   \___/_/ /_/\__, /\__/_/ /_/ 
                                                                                        /____/            */
#define DIOR_DRVSEL DIOR_CIOR_DRVSEL_DRV5                       //<---- set DQ drive strength
/*
    ____  __  ___  __   _________           __     _                    __                        __  __  
   / __ \/ / / | \/ /  / ____/   |     ____/ /____(_)   _____     _____/ /_________  ____  ____ _/ /_/ /_ 
  / /_/ / /_/ / \  /  / /   / /| |    / __  / ___/ / | / / _ \   / ___/ __/ ___/ _ \/ __ \/ __ `/ __/ __ \
 / ____/ __  /  / /  / /___/ ___ |   / /_/ / /  / /| |/ /  __/  (__  ) /_/ /  /  __/ / / / /_/ / /_/ / / /
/_/   /_/ /_/  /_/   \____/_/  |_|   \__,_/_/  /_/ |___/\___/  /____/\__/_/   \___/_/ /_/\__, /\__/_/ /_/ 
                                                                                        /____/            */
#define CIOR_DRVSEL DIOR_CIOR_DRVSEL_DRV5                       //<---- set CA drive strength
...
/*                       10MHz < freq < 266MHz                       */
    ...
    #if(DIOR_ODT_ON_OFF_STATE == DIOR_ODT_STATE_ON)
        #if (CY_USE_PSVP == 0)
        #if(FS1_WLS == WL_SET_A)
            #warning "ODTLon Latency not specified for this freq. range"
        #elif(FS1_WLS == WL_SET_B)
            #warning "ODTLon Latency not specified for this freq. range"
            #endif
        #elif (CY_USE_PSVP == 1)
        /* keep in mind. These value are actually not specified by JEDEC
            only for PSVP testing with very slow frequency  !!!   */
            #if(FS1_WLS == WL_SET_A)
                #define JESD209_4B_NCLK_ODTLON      4
            #elif(FS1_WLS == WL_SET_B)
                #define JESD209_4B_NCLK_ODTLON      12
            #endif
        #endif
    #endif
/*                       266MHz < freq < 533MHz                       */
...
/*                       533MHz < freq < 800MHz                       */
    ...
    #define CY_LPDDR_NRTP_FSP1                  8
            ...
            #warning "ODTLon Latency not specified for this freq. range"
        #elif(FS1_WLS == WL_SET_B)
            #define JESD209_4B_NCLK_ODTLON      6
        #endif
    #endif
/*                       800MHz < freq < 1066MHz                       */
...
/*                       1066MHz < freq < 1333MHz                       */
    ...
    #define CY_LPDDR_NRTP_FSP1                  10
            ...
            #define JESD209_4B_NCLK_ODTLON      4
        #elif(FS1_WLS == WL_SET_B)
            #define JESD209_4B_NCLK_ODTLON      14
        #endif
    #endif
/*                       1333MHz < freq < 1600MHz                       */
    ...
    #define CY_LPDDR_NRTP_FSP1                  12
            ...
            #define JESD209_4B_NCLK_ODTLON      6
        #elif(FS1_WLS == WL_SET_B)
            #define JESD209_4B_NCLK_ODTLON      18
        #endif
    #endif
/*                       1600MHz < freq < 1866MHz                       */
    ...
    #define CY_LPDDR_NRTP_FSP1                  14
            ...
            #define JESD209_4B_NCLK_ODTLON      6
        #elif(FS1_WLS == WL_SET_B)
            #define JESD209_4B_NCLK_ODTLON      20
        #endif
    #endif
/*                       1866MHz < freq < 2133MHz                       */
    ...
    #if(DIOR_ODT_ON_OFF_STATE == DIOR_ODT_STATE_ON)
        #if(FS1_WLS == WL_SET_A)
            #define JESD209_4B_NCLK_ODTLON      8
        #elif(FS1_WLS == WL_SET_B)
            #define JESD209_4B_NCLK_ODTLON      24
        #endif
    #endif
#endif
...
/** tODTon min in ns as specified in JEDEC 209-4B 800-2133MHz */
#define JESD209_4B_NS_TODTON_MIN    1.5

/** tODTon max in ns as specified in JEDEC 209-4B 800-2133MHz */
#define JESD209_4B_NS_TODTON_MAX    3.5

/** tODToff min in ns as specified in JEDEC 209-4B 800-2133MHz */
#define JESD209_4B_NS_TODTOFF_MIN   1.5

/** tODToff max in ns as specified in JEDEC 209-4B 800-2133MHz */
#define JESD209_4B_NS_TODTOFF_MAX   3.5
