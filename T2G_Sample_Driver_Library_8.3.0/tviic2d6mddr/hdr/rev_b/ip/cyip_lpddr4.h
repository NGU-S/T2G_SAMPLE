...
typedef struct stc_LPDDR4_LPDDR4_CORE_POM_field {
  ...
  uint32_t                         u1DLL_UPD_PERIODIC:1;
  uint32_t                         u1REL_REFEN:1;
  uint32_t                         :7;
...
typedef struct stc_LPDDR4_LPDDR4_CORE_DIOR_SL0_field {
  ...
  uint32_t                         u3RTT_SEL_GATE_TRAINING:3;
  uint32_t                         :10;
...
/**
  * \brief Dynamo Control Register 1 (LPDDR4_LPDDR4_CORE_DMCTL1)
  */
typedef struct stc_LPDDR4_LPDDR4_CORE_DMCTL1_field {
  uint32_t                         u8REF_POST_PULL_MAX:8;
  uint32_t                         :24;
} stc_LPDDR4_LPDDR4_CORE_DMCTL1_field_t;

typedef union un_LPDDR4_LPDDR4_CORE_DMCTL1 {
  uint32_t                         u32Register;
  stc_LPDDR4_LPDDR4_CORE_DMCTL1_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_LPDDR4_LPDDR4_CORE_DMCTL1_t;
...
/**
  * \brief Auto gate training Register (LPDDR4_LPDDR4_CORE_AUTOGT)
  */
typedef struct stc_LPDDR4_LPDDR4_CORE_AUTOGT_field {
  uint32_t                         u6GTS0:6;
  uint32_t                         u6GTS1:6;
  uint32_t                         u6GTS2:6;
  uint32_t                         u6GTS3:6;
  uint32_t                         :8;
} stc_LPDDR4_LPDDR4_CORE_AUTOGT_field_t;

typedef union un_LPDDR4_LPDDR4_CORE_AUTOGT {
  uint32_t                         u32Register;
  stc_LPDDR4_LPDDR4_CORE_AUTOGT_field_t stcField;
  uint8_t                          au8Byte[4];
  uint16_t                         au16Halfword[2];
} un_LPDDR4_LPDDR4_CORE_AUTOGT_t;
...
typedef struct stc_LPDDR4_LPDDR4_CORE {
  ...
  un_LPDDR4_LPDDR4_CORE_DMCTL1_t   unDMCTL1;           /*!< 0x00000318 Dynamo Control Register 1 */
  uint32_t                         au32Reserved3[697];
  ...
  un_LPDDR4_LPDDR4_CORE_AUTOGT_t   unAUTOGT;           /*!< 0x00000EB8 Auto gate training Register */
  uint32_t                         au32Reserved5[81];
...
typedef struct stc_LPDDR4 {
  ...
  stc_LPDDR4_LPDDR4_CORE_t         LPDDR4_CORE;        /*!< 0x00001000 N/A */
...
#define LPDDR4_LPDDR4_CORE_PHY_DLL_UPD_RATE_Pos 5UL
#define LPDDR4_LPDDR4_CORE_PHY_DLL_UPD_RATE_Msk 0x1FFE0UL
...
#define LPDDR4_LPDDR4_CORE_POM_DLL_UPD_PERIODIC_Pos 23UL
#define LPDDR4_LPDDR4_CORE_POM_DLL_UPD_PERIODIC_Msk 0x800000UL
#define LPDDR4_LPDDR4_CORE_POM_REL_REFEN_Pos    24UL
#define LPDDR4_LPDDR4_CORE_POM_REL_REFEN_Msk    0x1000000UL
...
#define LPDDR4_LPDDR4_CORE_DLLCTLCA_CH0_RSTEN_CA_Pos 22UL
#define LPDDR4_LPDDR4_CORE_DLLCTLCA_CH0_RSTEN_CA_Msk 0x400000UL
...
#define LPDDR4_LPDDR4_CORE_DLLCTLCA_CH1_RSTEN_CA_Pos 22UL
#define LPDDR4_LPDDR4_CORE_DLLCTLCA_CH1_RSTEN_CA_Msk 0x400000UL
...
#define LPDDR4_LPDDR4_CORE_DLLCTLDQ_SL0_RSTEN_DQ_Pos 16UL
#define LPDDR4_LPDDR4_CORE_DLLCTLDQ_SL0_RSTEN_DQ_Msk 0x10000UL
...
#define LPDDR4_LPDDR4_CORE_DLLCTLDQ_SL1_RSTEN_DQ_Pos 16UL
#define LPDDR4_LPDDR4_CORE_DLLCTLDQ_SL1_RSTEN_DQ_Msk 0x10000UL
...
#define LPDDR4_LPDDR4_CORE_DLLCTLDQ_SL2_RSTEN_DQ_Pos 16UL
#define LPDDR4_LPDDR4_CORE_DLLCTLDQ_SL2_RSTEN_DQ_Msk 0x10000UL
...
#define LPDDR4_LPDDR4_CORE_DLLCTLDQ_SL3_RSTEN_DQ_Pos 16UL
#define LPDDR4_LPDDR4_CORE_DLLCTLDQ_SL3_RSTEN_DQ_Msk 0x10000UL
...
#define LPDDR4_LPDDR4_CORE_DIOR_SL0_RTT_SEL_GATE_TRAINING_Pos 19UL
#define LPDDR4_LPDDR4_CORE_DIOR_SL0_RTT_SEL_GATE_TRAINING_Msk 0x380000UL
...
#define LPDDR4_LPDDR4_CORE_DIOR_SL1_RTT_SEL_GATE_TRAINING_Pos 19UL
#define LPDDR4_LPDDR4_CORE_DIOR_SL1_RTT_SEL_GATE_TRAINING_Msk 0x380000UL
...
#define LPDDR4_LPDDR4_CORE_DIOR_SL2_RTT_SEL_GATE_TRAINING_Pos 19UL
#define LPDDR4_LPDDR4_CORE_DIOR_SL2_RTT_SEL_GATE_TRAINING_Msk 0x380000UL
...
#define LPDDR4_LPDDR4_CORE_DIOR_SL3_RTT_SEL_GATE_TRAINING_Pos 19UL
#define LPDDR4_LPDDR4_CORE_DIOR_SL3_RTT_SEL_GATE_TRAINING_Msk 0x380000UL
...
#define LPDDR4_LPDDR4_CORE_TREG15_T_CMD_TO_BUS_Pos 17UL
#define LPDDR4_LPDDR4_CORE_TREG15_T_CMD_TO_BUS_Msk 0x1FFE0000UL
...
/* LPDDR4_LPDDR4_CORE.DMCTL1 */
#define LPDDR4_LPDDR4_CORE_DMCTL1_REF_POST_PULL_MAX_Pos 0UL
#define LPDDR4_LPDDR4_CORE_DMCTL1_REF_POST_PULL_MAX_Msk 0xFFUL
...
/* LPDDR4_LPDDR4_CORE.AUTOGT */
#define LPDDR4_LPDDR4_CORE_AUTOGT_GTS0_Pos      0UL
#define LPDDR4_LPDDR4_CORE_AUTOGT_GTS0_Msk      0x3FUL
#define LPDDR4_LPDDR4_CORE_AUTOGT_GTS1_Pos      6UL
#define LPDDR4_LPDDR4_CORE_AUTOGT_GTS1_Msk      0xFC0UL
#define LPDDR4_LPDDR4_CORE_AUTOGT_GTS2_Pos      12UL
#define LPDDR4_LPDDR4_CORE_AUTOGT_GTS2_Msk      0x3F000UL
#define LPDDR4_LPDDR4_CORE_AUTOGT_GTS3_Pos      18UL
#define LPDDR4_LPDDR4_CORE_AUTOGT_GTS3_Msk      0xFC0000UL
